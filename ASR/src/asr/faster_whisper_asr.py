...
class FasterWhisperASR(ASRInterface):
    def __init__(self, **kwargs):
        ...
        self.asr_pipeline = WhisperModel(model_size, device="cuda", compute_type="float16", num_workers=4, local_files_only=True)
    ...
    async def transcribe(self, client):
        ...
        segments, info = self.asr_pipeline.transcribe(file_path,
