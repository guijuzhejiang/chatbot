# coding=utf-8
# @Time : 2024/4/18 下午2:48
# @File : aws_infer_faster_whisper_web_demo.py
import argparse
import asyncio
import json
import os
...
def parse_args():
    ...
    parser.add_argument("--vad-args", type=str, default='{"auth_token": "huggingface_token", "model_name": "/home/ubuntu/models/pyannote/segmentation-3.0/pytorch_model.bin"}', help="JSON string of additional arguments for VAD pipeline")
    parser.add_argument("--asr-type", type=str, default="faster_whisper", help="Type of ASR pipeline to use (e.g., 'whisper')")
    parser.add_argument("--asr-args", type=str, default='{"model_size": "/home/ubuntu/models/guillaumekln/faster-whisper-large-v2"}', help="JSON string of additional arguments for ASR pipeline")
...
MODEL_NAME_ASR_JP = '/home/ubuntu/models/guillaumekln/faster-whisper-large-v2'
...
if __name__ == '__main__':
    ...
    demo.launch(server_name='0.0.0.0', server_port=8081, root_path='https://rr-chat.link')
